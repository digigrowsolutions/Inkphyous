              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">
                    <a href="mailto:info@inkphyous.com" className="text-blue-600 hover:underline">
                      info@inkphyous.com
                    </a>
                  </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Shipping times vary based on your location. Typically, orders within India are delivered in 5-7 business days, 
                while international orders may take 10-15 business days.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-2">Do you accept returns?</h3>
              <p className="text-gray-600">
                Yes, we accept returns within 30 days of purchase for most items. Please ensure the product is unused and 
                in its original packaging. Contact us for more details on our return policy.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                We accept Credit/Debit Cards (Visa, MasterCard, AMEX), UPI payments (Google Pay, PhonePe, BHIM), 
                digital wallets (Paytm, Razorpay), and Cash on Delivery (COD) with additional charges.
              </p>
            </div>
          </div>
        </div>
