            ...
            >
              ...
              <div className="text-right">
                ...
                <div className="text-gray-700 text-sm leading-relaxed space-y-4">
                  <div className="[&_ul]:ml-6 [&_ul]:list-disc [&_ul]:text-right [&_ol]:ml-6 [&_ol]:text-right">
                    {section.content}
                  </div>
                </div>
              </div>
        ...
        content: (
          <div className="space-y-3 text-gray-700 leading-relaxed">
            ...
            <div className="ml-4 space-y-4">
              <div>
                <p className="font-semibold label">a. Personal Information</p>
              ...
              <div>
                <p className="font-semibold label">b. Non-Personal Information</p>
              ...
              <div>
                <p className="font-semibold label">c. Transactional Information</p>
